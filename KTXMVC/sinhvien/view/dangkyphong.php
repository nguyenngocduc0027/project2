...
//?>
<h2 class="card-title text-center">ĐĂNG KÝ PHÒNG</h2><hr>
    ...
    <div class="form-group">
        ...
        <h5>Chọn Số Người Của 1 Phòng :</h5>
            <div class="custom-control custom-checkbox" style="margin-left: 30px;">
              ...
              <label class="custom-control-label" for="customCheck1"><p> Phòng 4 Người</p></label>
          </div>
          <div class="custom-control custom-checkbox" style="margin-left: 30px;">
              <input type="radio" class="custom-control-input" id="customCheck2" value="6" name="sno"  >
              <label class="custom-control-label" for="customCheck2"><p>Phòng 6 Người</p></label>
          </div>
          <div class="custom-control custom-checkbox" style="margin-left: 30px;">
              <input type="radio" class="custom-control-input" id="customCheck3" value="8" name="sno"  >
              <label class="custom-control-label" for="customCheck3"><p>Phòng 8 Người</p></label>
          </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <table class="table text-center badge-light">
        ...
        <thead class="badge-info">
          <tr>
            <th>#</th><th>Học Kỳ</th><th>Phòng 8 Người </th><th>Phòng 10 Người </th><th>Phòng 12 Người </th>
          </tr>
        </thead>
        <tbody>
